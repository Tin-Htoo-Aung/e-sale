...
<body>
    <div id="app">
        ...
        <div class="row" style="padding-top:100px; padding-left:50px;">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header" style="color:white; background-color:#696969;"> <b> Sale Post {{$sale->id}} </b></div>

                    <div class="card-body">
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <center>
                                        <img src="{{Storage::url($sale->photo)}}" width="200" height="200">
                                    </center>
                                </div>    
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="name" type="text" class="form-control" name="name" value="{{$sale->name}}" disabled>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input style="height:200px;" id="description" type="text" class="form-control" name="description" value="{{$sale->description}}" disabled>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="condition" type="text" class="form-control" name="condition" value="{{$sale->condition}}" disabled>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="price" type="text" class="form-control" name="price" value="{{$sale->price}} Kyats" disabled>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" id="calculate" value="{{$sale->transfer}} Kyats" disabled>
                                    <input style="width:400px;" type="text" id="service" value="{{$sale->service}} Kyats will be cut as services fees." disabled>
                                </div>
                            </div>
                        </form>
                    </div>
